...
- ❌ Add `postMessage`/`window.parent`/`window.top` beyond the two sanctioned outbound signals (`sim:ready` boot, `sim:complete` lesson-finish), a second reset path, or any non-CDN network call. *(§2.9, §2.10, §2.12)*
