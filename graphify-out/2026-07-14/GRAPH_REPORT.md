# Graph Report - Simatrix  (2026-07-14)

## Corpus Check
- 193 files · ~1,708,727 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3682 nodes · 5065 edges · 391 communities (181 shown, 210 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 111 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6f7376f8`
...
- Product
- CLAUDE.md — Simatrix: Understanding Orthographic Views
- CLAUDE.md — Simatrix Starter Template
- CLAUDE.md — Simatrix · [Subject Name] · [Module/Topic Name]
...
1. `Communities (349 total, 210 thin omitted)` - 136 edges
2. `Communities (346 total, 210 thin omitted)` - 133 edges
3. `Communities (345 total, 210 thin omitted)` - 132 edges
4. `Communities (136 total, 45 thin omitted)` - 87 edges
5. `Simatrix — Decisions (ADR Log)` - 51 edges
6. `Simatrix — Decisions (ADR Log)` - 51 edges
7. `$()` - 29 edges
8. `asg()` - 28 edges
9. `rebuild()` - 26 edges
10. `alb()` - 25 edges
...
## Communities (391 total, 210 thin omitted)

### Community 0 - "First-Angle Projection Scene"
Cohesion: 0.07
Nodes (46): animate(), applyDimensionVisibility(), applyMode(), applyProjectionMorph(), buildScene(), computeEffectiveAngles(), createEdgeOverlay(), cssColor() (+38 more)
...
Cohesion: 0.06
Nodes (41): ADR-0021, animate(), applyProjectionMorph(), CAMERA_POSE, compare, currentData, currentView, ensureWorkbenchRail() (+33 more)
...
Cohesion: 0.10
Nodes (22): active, cancelAll(), easeCamera, easeDissolve, easeDraw, easeFold, easeStandard, tick() (+14 more)
...
Cohesion: 0.15
Nodes (19): easeCamera, animateFold(), announceState(), declutterChipLabels(), foldBack(), foldForward(), foldLabels(), notifyStateChange() (+11 more)

### Community 28 - "lineDrawer"
Cohesion: 0.18
Nodes (22): $(), closeTerm(), cueOrthoLock(), disarmReset(), enterWorkbench(), exitWorkbench(), goBack(), goNext() (+14 more)
...
### Community 31 - "main"
Cohesion: 0.18
Nodes (16): announce(), applyCompareSize(), completeAndNext(), exitWorkbench(), handleResize(), init(), isWorkbenchViewport(), markBooted() (+8 more)

### Community 32 - "main"
Cohesion: 0.10
Nodes (19): 2026-07-06, 2026-07-06 (Phase 2 — pipeline rewire), 2026-07-07 (Phase 3 fixes — ADR compliance), 2026-07-07 (Phase 3 — UI shell, guided sequence, labels), 2026-07-07 (Phase 4 — Problem Library + textbook problem sets), 2026-07-07 (Phase 5 — final polish: line conventions, quick-views, leak cert), 2026-07-08 (Dual-camera ortho quick-views — enforce RULES.md §5.18), 2026-07-08 (Phase 6 — UI/UX polish: quadrant grid, negative PP, Compare mirrors lateral) (+11 more)
...
### Community 62 - "DESIGN"
Cohesion: 0.18
Nodes (16): buildScene(), clearProjectionMorph(), cssColor(), engageOrtho(), ensurePerspectiveActive(), exitFrontViewSmooth(), frameToBlock(), handleResize() (+8 more)
...
Cohesion: 0.28
Nodes (9): beginOverlay(), buildCtx(), fill(), prepFoldScene(), refillCompare(), reflowView(), s2Px(), s3Px() (+1 more)
...
### Community 347 - "initUIManager"
Cohesion: 0.01
Nodes (136): Communities (349 total, 210 thin omitted), Community 0 - "First-Angle Projection Scene", Community 100 - "terms", Community 101 - "CHANGELOG", Community 102 - "problemLibrary", Community 103 - "uiManager", Community 104 - "2026-06-01T14-57-13Z__index-html", Community 105 - "terms" (+128 more)

### Community 348 - "reset"
Cohesion: 0.02
Nodes (133): Communities (346 total, 210 thin omitted), Community 0 - "First-Angle Projection Scene", Community 100 - "terms", Community 101 - "CHANGELOG", Community 102 - "problemLibrary", Community 103 - "uiManager", Community 104 - "2026-06-01T14-57-13Z__index-html", Community 105 - "terms" (+125 more)

### Community 349 - "Communities (345 total, 210 thin omitted)"
Cohesion: 0.02
Nodes (132): Communities (345 total, 210 thin omitted), Community 0 - "First-Angle Projection Scene", Community 100 - "terms", Community 101 - "CHANGELOG", Community 102 - "problemLibrary", Community 103 - "uiManager", Community 104 - "2026-06-01T14-57-13Z__index-html", Community 105 - "terms" (+124 more)

### Community 350 - "Communities (136 total, 45 thin omitted)"
Cohesion: 0.02
Nodes (87): Communities (136 total, 45 thin omitted), Community 0 - "First-Angle Projection Scene", Community 10 - "Solid Generators (clone)", Community 11 - "Platform Design System", Community 12 - "ADR Index & Compare View", Community 13 - "Dimensioning & Line Types", Community 14 - "Fold Camera Choreography", Community 15 - "Projection Drawer" (+79 more)

### Community 351 - "Simatrix — Decisions (ADR Log)"
Cohesion: 0.04
Nodes (51): ADR-000: [Template — copy this for a new entry], ADR-001: No build step; ship pinned CDN ES modules, ADR-002: Host integration via a `window.simAPI` global, not `postMessage`, ADR-003: CSS design tokens are the single runtime source of truth for all visual values, ADR-004: Every geometry change funnels through one `rebuild()` pipeline, ADR-005: Re-derive every ported sign visually (Unity left-handed → Three.js right-handed), explicit ZXY Euler, ADR-006: Fat lines + hard-edge geometry + quantized edge welding for crisp technical linework, ADR-007: Orchestrator + leaf modules — leaves don't cross-import; only `genericSolid` (pure math) is shared (+43 more)

### Community 352 - "Design System: Simatrix Guided Stepper"
Cohesion: 0.04
Nodes (45): 1. Overview, 2. Colors, 3. Typography, 4. Elevation, 5. Components, 6. Do's and Don'ts, Anti-Patterns Verdict, Anti-Patterns Verdict (+37 more)

### Community 353 - "5. Component standards"
Cohesion: 0.06
Nodes (34): 1. Purpose and scope of this file, 2.1 The token table (verified against code), 2.2 Module-1 construction-aid encodings (Lines sim), 2.3 The named colour rules (binding everywhere), 2. Color system, 3.1 Where the fonts are hosted, 3.2 When each font is used (hierarchy), 3.3 The named type rules (+26 more)

### Community 354 - "Simatrix — MODULE-STARTER"
Cohesion: 0.06
Nodes (33): 3.10 Register the topic in `ARCHITECTURE.md`, 3.1 Name the folder, 3.2 Copy the master, whole, 3.3 File-by-file: keep exactly as copied (the shared contracts), 3.4 File-by-file: adapt (the topic-specific content), 3.5 File-by-file: create fresh (only if your topic needs them), 3.6 Update `meta.json` (every field), 3.7 Update the new folder's `CLAUDE.md` (the pointer to root docs) (+25 more)

### Community 355 - "DESIGN.md — Module 1 Premium Interaction Layer"
Cohesion: 0.06
Nodes (33): Anti-Patterns Verdict, Anti-Patterns Verdict, Card geometry & facade, Chrome-injection contract, Cinematic fold camera, Compare View contract, Compare workbench (Lines — `cfg.workbenchControls`), CSS keyframes (+25 more)

### Community 356 - "Section 3: Case A Step-by-Step — New Module 2 Topic"
Cohesion: 0.06
Nodes (32): 3.10 Register the topic in `ARCHITECTURE.md`, 3.1 Name the folder, 3.2 Copy the master, whole, 3.3 File-by-file: keep exactly as copied (the shared contracts), 3.4 File-by-file: adapt (the topic-specific content), 3.5 File-by-file: create fresh (only if your topic needs them), 3.6 Update `meta.json` (every field), 3.7 Update the new folder's `CLAUDE.md` (the pointer to root docs) (+24 more)

### Community 357 - "Section 3: Case A Step-by-Step — New Module 2 Topic"
Cohesion: 0.06
Nodes (32): 3.10 Register the topic in `ARCHITECTURE.md`, 3.1 Name the folder, 3.2 Duplicate `template_starter/`, then restore the solids, 3.3 File-by-file: keep exactly as copied (the shared contracts), 3.4 File-by-file: adapt (the topic-specific content), 3.5 File-by-file: create fresh (only if your topic needs them), 3.6 Update `meta.json` (every field), 3.7 Update the new folder's `CLAUDE.md` (the pointer to root docs) (+24 more)

### Community 358 - "The Simatrix Documentation System"
Cohesion: 0.07
Nodes (30): A Reusable Methodology for Solo and Small-Team Software Projects, ARCHITECTURE.md — The Map, CLAUDE.module-template.md — The New-Family Starter, DECISIONS.md — The Diary, DESIGN.md — The Visual Contract, How CLAUDE.md Connects Everything, MODULE-STARTER.md — The Onboarding Playbook, PLATFORM-RULES.md — The Subject-Agnostic Foundation (+22 more)

### Community 359 - "5. Components"
Cohesion: 0.07
Nodes (29): 1. Overview, 2. Colors, 3. Typography, 4. Elevation, 5. Components, 6. Do's and Don'ts, Buttons, Cards / Containers (+21 more)

### Community 360 - "5. Components"
Cohesion: 0.07
Nodes (29): 1. Overview, 2. Colors, 3. Typography, 4. Elevation, 5. Components, 6. Do's and Don'ts, Buttons, Cards / Containers (+21 more)

### Community 361 - "CLAUDE.md — Simatrix Engineering Graphics · Module 1"
Cohesion: 0.08
Nodes (26): 2D drawing conventions (after HP unfolds 90° about the X fold line), 2D sign logic per quadrant, 3D scene conventions (right-handed, Y-up — Three.js default), Architecture (non-negotiable), Cinematic camera (this OVERTURNS the old "camera never moves during the fold" rule), Cinematic reversible fold animation (fold ⇄ unfold, camera sweeps square-on), CLAUDE.md — Simatrix Engineering Graphics · Module 1, Colour convention (platform functional encodings — read from CSS tokens) (+18 more)

### Community 362 - "Changelog"
Cohesion: 0.08
Nodes (25): 2026-06-29, 2026-06-30, 2026-06-30 (Phase 2 — logic & interactivity), 2026-06-30 (Phase 3.1 — restore dashed hidden lines, keep X-ray), 2026-06-30 (Phase 3.2 — persistent X-ray, seam & hidden-line fixes), 2026-06-30 (Phase 3 — projection morph, X-ray overhaul & UI parity), 2026-07-01 (Completion-state cleanup + Back-button parity), 2026-07-01 (Content & Pedagogy Upgrade — foundations content model) (+17 more)

### Community 363 - "Changelog"
Cohesion: 0.09
Nodes (23): 2026-07-02 (3D content: planes, point, cinematic fold), 2026-07-02 (Data layer + registration), 2026-07-02 (Guided stepper), 2026-07-02 (Scaffold), 2026-07-03 (CSS2D label layer — topic complete), 2026-07-03 (Dock removal + full-height step rail — Module 2 convergence), 2026-07-03 (Param-control relocation + step-name trim — UI regression fix), 2026-07-03 (Step-rail button layout — narrow-rail fix) (+15 more)

### Community 364 - "Critique — Orthographic Projection Guided Stepper (`index.html`)"
Cohesion: 0.09
Nodes (22): Anti-Patterns Verdict, Anti-Patterns Verdict, Critique — Orthographic Projection Guided Stepper (`index.html`), Design Health Score, Design Health Score, Minor Observations, Minor Observations, Overall Impression (+14 more)

### Community 365 - "Critique — Orthographic Projection Guided Stepper (`index.html`)"
Cohesion: 0.09
Nodes (22): Anti-Patterns Verdict, Anti-Patterns Verdict, Critique — Orthographic Projection Guided Stepper (`index.html`), Design Health Score, Design Health Score, Minor Observations, Minor Observations, Overall Impression (+14 more)

### Community 366 - "Simatrix — Architecture"
Cohesion: 0.10
Nodes (21): 1. What Simatrix Is, 2. Codebase Map, 3. Module 2 — Component Breakdown (the master), 4. Module 1 — Component Breakdown (foundations of projection), 5. Data Flow — How a User Interaction Reaches the Scene, 6. The iframe Boundary, 7. What Is Shared Across All Codebases, 8. What Is Intentionally Different Between Modules (+13 more)

### Community 367 - "codebase.md"
Cohesion: 0.10
Nodes (19): 1. Subject, 2026-06-16, 2026-07-02, 2026-07-02, 2026-07-02, 2026-07-09, 2026-07-09, 2026-07-09 (+11 more)

### Community 368 - "Changelog — Projection of Points"
Cohesion: 0.11
Nodes (19): 2026-07-06, 2026-07-06 (Phase 2 — pipeline rewire), 2026-07-07 (Phase 3 fixes — ADR compliance), 2026-07-07 (Phase 3 — UI shell, guided sequence, labels), 2026-07-07 (Phase 4 — Problem Library + textbook problem sets), 2026-07-07 (Phase 5 — final polish: line conventions, quick-views, leak cert), 2026-07-08 (Dual-camera ortho quick-views — enforce RULES.md §5.18), 2026-07-08 (Phase 6 — UI/UX polish: quadrant grid, negative PP, Compare mirrors lateral) (+11 more)

### Community 369 - "Simatrix — Rules (Enforcement Checklist)"
Cohesion: 0.13
Nodes (15): How to add a rule, How to read a rule, Preamble, Section 1 — Master Codebase & Deployment Rules, Section 2 — Platform & Runtime Rules, Section 3 — 3D Scene & Architecture Rules, Section 4 — UI & Visual Rules (Cross-Module Standards), Section 5 — Camera & Animation Rules (+7 more)

### Community 370 - "Changelog — Understanding Orthographic Views"
Cohesion: 0.14
Nodes (14): 2026-07-11, 2026-07-12, 2026-07-12 (completion — cinematic unfold + 2D Compare), 2026-07-13 (ADR-050 final flag — 2D Compare sheet synced to the mathematical views), 2026-07-13 (cleanup pass — rename, camera default, dead-UI purge, Reset fix), 2026-07-13 (domain geometry & fold fixes — true silhouettes, PP-onto-HP fold, exploded labelled planes, CSS2D Observer), 2026-07-13 (domain overhaul — Bearing Block, grid planes, 5-step sequence), 2026-07-13 (final QA polish — framing, projector purge & exact 2D silhouettes, ADR-050) (+6 more)

### Community 371 - "Simatrix — Product"
Cohesion: 0.17
Nodes (12): 1. What Simatrix is, 2. Who it is for, 3. What it is not (anti-references), 4. Core design principles, 5. Features — Module 1 (audit-verified), 6. Features — Module 2 (audit-verified), 7. Accessibility commitments (with implementation status), 8. Planned but not yet implemented (+4 more)

### Community 372 - "CLAUDE.md — Simatrix · Module 1 Topic 1: Engineering Graphics Foundations (BUILT)"
Cohesion: 0.17
Nodes (12): CLAUDE.md — Simatrix · Module 1 Topic 1: Engineering Graphics Foundations (BUILT), Decision 1 — Canonical "Front Face", Decision 2 — Fully orbitable in 3D, every step (no 2D camera lock), Decision 3 — RETAIN `meshAnalyzer.js` + the dynamic projection/line-drawing machinery, Decision 4 — BIS line-type mapping for the Front Face, Non-negotiables inherited from Module 2 (apply unchanged), Open questions (geometry to verify before build) — see chat, Refactor intent (what this overturns) (+4 more)

### Community 373 - "Changelog — Simatrix (repository root)"
Cohesion: 0.18
Nodes (11): 2026-06-27, 2026-06-28, 2026-06-29, 2026-07-02, 2026-07-03, 2026-07-09, 2026-07-10, 2026-07-11 (+3 more)

### Community 374 - "CLAUDE.md — Simatrix Projection of Points"
Cohesion: 0.18
Nodes (11): 3D engineering gotchas (read before writing rotation/projection math), Architecture (non-negotiable), CLAUDE.md — Simatrix Projection of Points, Cross-cutting rules, Keeping Root Documents Current, Platform contract (required for Simatrix uploads), Project-wide documentation (read before cross-module tasks), Rotation priority hierarchy (pedagogically critical) (+3 more)

### Community 375 - "CLAUDE.md — Simatrix Engineering Graphics Viewer"
Cohesion: 0.18
Nodes (11): 3D engineering gotchas (read before writing rotation/projection math), Architecture (non-negotiable), CLAUDE.md — Simatrix Engineering Graphics Viewer, Cross-cutting rules, Keeping Root Documents Current, Platform contract (required for Simatrix uploads), Project-wide documentation (read before cross-module tasks), Rotation priority hierarchy (pedagogically critical) (+3 more)

### Community 376 - "Graph Report - Simatrix  (2026-07-14)"
Cohesion: 0.18
Nodes (11): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Freshness, Graph Report - Simatrix  (2026-07-14), Hyperedges (group relationships), Import Cycles, Knowledge Gaps (+3 more)

### Community 377 - "Graph Report - Simatrix  (2026-07-13)"
Cohesion: 0.18
Nodes (11): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Freshness, Graph Report - Simatrix  (2026-07-13), Hyperedges (group relationships), Import Cycles, Knowledge Gaps (+3 more)

### Community 378 - "Graph Report - Simatrix  (2026-07-14)"
Cohesion: 0.18
Nodes (11): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Freshness, Graph Report - Simatrix  (2026-07-14), Hyperedges (group relationships), Import Cycles, Knowledge Gaps (+3 more)
...
### Community 380 - "Graph Report - .  (2026-07-12)"
Cohesion: 0.20
Nodes (10): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Report - .  (2026-07-12), Hyperedges (group relationships), Import Cycles, Knowledge Gaps, Suggested Questions (+2 more)

### Community 381 - "CLAUDE.md — Simatrix · Module 1 Topic 2: Spatial Framework (BUILT)"
Cohesion: 0.22
Nodes (9): Architecture — Module 2 orchestrator pattern (ADR-033, overturns ADR-011 for this topic), CLAUDE.md — Simatrix · Module 1 Topic 2: Spatial Framework (BUILT), File structure, Non-negotiables inherited from the platform (apply unchanged), Platform contract (already wired — do not add a second path), Project-wide documentation (read before cross-module tasks), SESSION DIGEST — [date] — [feature/task], Session Digest Protocol (+1 more)

### Community 382 - "CLAUDE.md — Simatrix · Module 2 Topic 1: Introduction to Solids"
Cohesion: 0.25
Nodes (8): 3D engineering gotchas (read before writing rotation/projection math), Architecture (non-negotiable), CLAUDE.md — Simatrix · Module 2 Topic 1: Introduction to Solids, Cross-cutting rules, Platform contract (required for Simatrix uploads), Project-wide documentation (read before cross-module tasks), Rotation priority hierarchy (pedagogically critical), Visual style

### Community 383 - "CLAUDE.md — Simatrix Engineering Graphics Viewer"
Cohesion: 0.25
Nodes (8): 3D engineering gotchas (read before writing rotation/projection math), Architecture (non-negotiable), CLAUDE.md — Simatrix Engineering Graphics Viewer, Cross-cutting rules, Platform contract (required for Simatrix uploads), Pose model — SIMPLE POSITIONS (this clone), Project-wide documentation (read before cross-module tasks), Visual style

### Community 384 - "Product"
Cohesion: 0.25
Nodes (8): Accessibility & Inclusion, Anti-references, Brand Personality, Design Principles, Product, Product Purpose, Register, Users

### Community 385 - "CLAUDE.md — Simatrix: Understanding Orthographic Views"
Cohesion: 0.29
Nodes (7): Architecture (non-negotiable), CLAUDE.md — Simatrix: Understanding Orthographic Views, Platform contract (required for Simatrix uploads), Project-wide documentation (read before cross-module tasks), SESSION DIGEST — [date] — [feature/task], Session Digest Protocol, This topic's architecture

### Community 386 - "CLAUDE.md — Simatrix Starter Template"
Cohesion: 0.29
Nodes (7): Before you write any code, CLAUDE.md — Simatrix Starter Template, Keeping your own documents current, Project-wide documentation (read before cross-module tasks), SESSION DIGEST — [date] — [feature/task], Session Digest Protocol, Subject-specific architecture rules

### Community 387 - "CLAUDE.md — Simatrix · [Subject Name] · [Module/Topic Name]"
Cohesion: 0.29
Nodes (7): Before you write any code, CLAUDE.md — Simatrix · [Subject Name] · [Module/Topic Name], Keeping your own documents current, Project-wide documentation (read before cross-module tasks), SESSION DIGEST — [date] — [feature/task], Session Digest Protocol, Subject-specific architecture rules

### Community 388 - "Simatrix — Platform Rules (Subject-Agnostic Foundation)"
Cohesion: 0.29
Nodes (7): How to read a rule, Section 1 — Platform & Runtime Contract, Section 2 — UI & Visual Rules, Section 3 — Cross-Subject Harmony, Section 4 — Documentation Rules, Section 5 — Anti-Patterns (Quick Scan), Simatrix — Platform Rules (Subject-Agnostic Foundation)

### Community 389 - "Simatrix"
Cohesion: 0.33
Nodes (6): 1. What Simatrix is, 2. Who it is for, 3. What it is not (anti-references), Brand personality, Simatrix, What this design contract covers — and what it doesn't

### Community 390 - "onboarding.js"
Cohesion: 0.40
Nodes (3): initOnboarding(), SPOTLIGHTS, TONE_CLASSES

### Community 391 - "problemLibrary.js"
Cohesion: 0.40
Nodes (4): initProblemLibrary(), ADR-0007, ADR-0015, ADR-0033

## Knowledge Gaps
- **2242 isolated node(s):** `FEEDBACK`, `SYM`, `NOHALO`, `reduceMotion`, `DEF` (+2237 more)
...
- **Why does `armReset()` connect `terms` to `uiManager`, `anim`, `ADR Index & Compare View`, `lineDrawer`, `main`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `main` to `First-Angle Projection Scene`, `terms`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Communities (349 total, 210 thin omitted)` connect `initUIManager` to `Graph Report - Simatrix  (2026-07-14)`?**
