# Graph Report - Simatrix  (2026-07-20)

## Corpus Check
- 286 files · ~699,651 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3533 nodes · 5647 edges · 402 communities (194 shown, 208 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 138 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `60b8ece1`
...
1. `Simatrix — Decisions (ADR Log)` - 76 edges
2. `$()` - 29 edges
3. `asg()` - 28 edges
4. `rebuild()` - 26 edges
5. `alb()` - 25 edges
...
9. `Changelog — Projection of Points` - 22 edges
...
- `initUIManager()` --indirect_call--> `armReset()`  [INFERRED]
  graphics_module_1_topic_5_projection_of_line_types/src/uiManager.js → Module1/src/engine.js
- `initUIManager()` --indirect_call--> `armReset()`  [INFERRED]
  graphics_module_1_topic_6_projection_of_straight_lines/src/uiManager.js → Module1/src/engine.js
...
## Communities (402 total, 208 thin omitted)
...
Cohesion: 0.05
Nodes (52): animate(), applyProjectionMorph(), buildScene(), compare, computeEffectiveAngles(), createEdgeOverlay(), cssColor(), cssVar() (+44 more)

### Community 2 - "Projection Orchestrator"
Cohesion: 0.13
Nodes (44): buildAnimScene(), draw3D(), drawStage(), firstAngleSymbol(), SYM, draw3D(), angle3(), asgBold() (+36 more)
...
Cohesion: 0.06
Nodes (37): CAMERA_POSE, compare, currentData, currentView, fitOrthoZoom(), fitOrthoZoomForView(), hasDialedWork(), ADR-0004 (+29 more)
...
Cohesion: 0.05
Nodes (38): 1. Purpose and scope of this file, 2.1 The token table (verified against code), 2.2 Module-1 construction-aid encodings (Lines sim), 2.3 The named colour rules (binding everywhere), 2. Color system, 3.1 Where the fonts are hosted, 3.2 When each font is used (hierarchy), 3.3 The named type rules (+30 more)
...
Cohesion: 0.07
Nodes (28): active, cancelAll(), easeDissolve, easeDraw, easeFold, easeStandard, tick(), applyProjectionMorph() (+20 more)
...
Cohesion: 0.12
Nodes (24): $(), afterRebuild(), draw3D(), FEEDBACK, mark(), wireControls(), draw3D(), FOCUS (+16 more)
...
Cohesion: 0.08
Nodes (24): 2026-07-02 (3D content: planes, point, cinematic fold), 2026-07-02 (Data layer + registration), 2026-07-02 (Guided stepper), 2026-07-02 (Scaffold), 2026-07-03 (CSS2D label layer — topic complete), 2026-07-03 (Dock removal + full-height step rail — Module 2 convergence), 2026-07-03 (Param-control relocation + step-name trim — UI regression fix), 2026-07-03 (Step-rail button layout — narrow-rail fix) (+16 more)
...
Cohesion: 0.13
Nodes (16): announce(), buildScene(), computeRegions(), cssColor(), cueOrthoLock(), handleResize(), init(), markBooted() (+8 more)

### Community 29 - "main"
Cohesion: 0.26
Nodes (17): announce(), answerSheetBox(), clearProjectionMorph(), engageOrtho(), fitOrthoZoom(), flattenedViewBox(), restorePerspective(), setConnectorsVisible() (+9 more)
...
### Community 31 - "main"
Cohesion: 0.11
Nodes (25): announce(), applyCompareSize(), completeAndNext(), ensureWorkbenchRail(), enterWorkbench(), exitWorkbench(), handleResize(), init() (+17 more)

### Community 32 - "main"
Cohesion: 0.09
Nodes (22): 2026-07-06, 2026-07-06 (Phase 2 — pipeline rewire), 2026-07-07 (Phase 3 fixes — ADR compliance), 2026-07-07 (Phase 3 — UI shell, guided sequence, labels), 2026-07-07 (Phase 4 — Problem Library + textbook problem sets), 2026-07-07 (Phase 5 — final polish: line conventions, quick-views, leak cert), 2026-07-08 (Dual-camera ortho quick-views — enforce RULES.md §5.18), 2026-07-08 (Phase 6 — UI/UX polish: quadrant grid, negative PP, Compare mirrors lateral) (+14 more)
...
Cohesion: 0.13
Nodes (20): animateFold(), applyDimensionVisibility(), applyFoldVisual(), applyProfilePlaneVisibility(), disposeActiveProjection(), refreshProjections(), setDimensionsVisible(), setObjectOpacity() (+12 more)
...
### Community 38 - "rebuild"
Cohesion: 0.12
Nodes (24): easeCamera, animateFold(), announceState(), buildCtx(), clearProjectionMorph(), declutterChipLabels(), foldBack(), foldForward() (+16 more)

### Community 39 - "anim.js"
Cohesion: 0.23
Nodes (12): addProjectionViews(), buildSectionViews(), cssColor(), fatSegments(), hatchLoops2D(), ADR-0038, ADR-0042, ADR-0060 (+4 more)
...
Cohesion: 0.19
Nodes (16): buildScene(), clearProjectionMorph(), clearQuickView(), cssColor(), cueOrthoLock(), driveFold(), engageOrtho(), flyCamera() (+8 more)
...
### Community 43 - "anim"
Cohesion: 0.10
Nodes (24): announce(), applyCompareSize(), drawCompare(), ensureWorkbenchRail(), enterWorkbench(), exitWorkbench(), handleResize(), init() (+16 more)
...
Cohesion: 0.13
Nodes (20): animateFold(), applyDimensionVisibility(), applyFoldVisual(), applyMode(), applyProfilePlaneVisibility(), disposeActiveProjection(), notifyStateChange(), positionRefLabels() (+12 more)
...
### Community 57 - "trueLength.js"
Cohesion: 0.22
Nodes (7): active, cancelAll(), easeCamera, easeDissolve, easeDraw, easeFold, easeStandard

### Community 58 - "problemLibrary.js"
Cohesion: 0.06
Nodes (36): applyCompareSize(), CAMERA_POSITION, CAMERA_TARGET, compare, currentData, currentView, DEFAULT_VIEW, ensureCompareForCon() (+28 more)
...
Cohesion: 0.12
Nodes (15): 2026-06-27, 2026-06-28, 2026-06-29, 2026-07-02, 2026-07-03, 2026-07-09, 2026-07-10, 2026-07-11 (+7 more)
...
Cohesion: 0.20
Nodes (9): DEFAULT_VIEW, ADR-0012, STEPS, TERMS, initStepper(), ADR-0007, ADR-0037, initTerms() (+1 more)
...
Cohesion: 0.17
Nodes (11): 2026-06-16, 2026-06-19, 2026-06-20, 2026-06-25, 2026-06-26, 2026-06-27, 2026-06-28, 2026-07-09 (+3 more)
...
Cohesion: 0.04
Nodes (62): announce(), applyCompareSize(), buildScene(), CAMERA_POSITION, CAMERA_TARGET, compare, completeAndNext(), computeRegions() (+54 more)
...
Cohesion: 0.05
Nodes (60): ADR-0061, addEdgeOverlay(), addSectionPlaneVisual(), animate(), announce(), applySectionCut(), applyStageVisibility(), buildScene() (+52 more)
...
Cohesion: 0.25
Nodes (7): 2026-06-16, 2026-07-02, 2026-07-09, 2026-07-15, 2026-07-16, 2026-07-20, Changelog

### Community 126 - "CLAUDE"
Cohesion: 0.40
Nodes (4): 2026-07-02, 2026-07-09, 2026-07-20, Changelog

### Community 127 - "DESIGN"
Cohesion: 0.33
Nodes (5): 2026-07-02, 2026-07-09, 2026-07-16, 2026-07-20, Changelog

### Community 128 - "anim.js"
Cohesion: 0.24
Nodes (10): commit(), contentBoxWorld(), disposeContent(), drawCompare(), flatSheetBox(), notifyStateChange(), rebuild(), viewportSize() (+2 more)

### Community 130 - "DESIGN"
Cohesion: 0.12
Nodes (15): 2026-07-11, 2026-07-12, 2026-07-12 (completion — cinematic unfold + 2D Compare), 2026-07-13 (ADR-050 final flag — 2D Compare sheet synced to the mathematical views), 2026-07-13 (cleanup pass — rename, camera default, dead-UI purge, Reset fix), 2026-07-13 (domain geometry & fold fixes — true silhouettes, PP-onto-HP fold, exploded labelled planes, CSS2D Observer), 2026-07-13 (domain overhaul — Bearing Block, grid planes, 5-step sequence), 2026-07-13 (final QA polish — framing, projector purge & exact 2D silhouettes, ADR-050) (+7 more)
...
Cohesion: 0.40
Nodes (4): 2026-07-11, 2026-07-16, 2026-07-20, Changelog — Simatrix Starter Template
...
Cohesion: 0.19
Nodes (13): $(), syncUI(), HPVT(), QNAME, sync(), VPVT(), wireControls(), setNote() (+5 more)
...
### Community 347 - "dimensions.js"
Cohesion: 0.23
Nodes (10): addLinearDimension(), ADR-0006, ADR-0007, ADR-0041, pushArrow(), addLabel(), disposeLabels(), ADR-0003 (+2 more)
...
Cohesion: 0.16
Nodes (17): createSolidMesh(), buildConeGeometry(), createCone(), cssColor(), rootStyle, createCube(), cssColor(), rootStyle (+9 more)

### Community 350 - "initUIManager"
Cohesion: 0.60
Nodes (4): clamp(), initUIManager(), parseNumeric(), SLIDERS

### Community 351 - "genericPrism.js"
Cohesion: 0.24
...
### Community 352 - "CLAUDE.md — Simatrix Engineering Graphics Viewer — Sections of Solids"
Cohesion: 0.15
Nodes (12): 3D engineering gotchas (read before writing rotation/projection math), Architecture (non-negotiable), CLAUDE.md — Simatrix Engineering Graphics Viewer — Sections of Solids, Cross-cutting rules, Geometry engine (restored from Module 2, byte-identical — ADR-009), Keeping Root Documents Current, Platform contract (required for Simatrix uploads), Project-wide documentation (read before cross-module tasks) (+4 more)

### Community 353 - "init"
Cohesion: 0.06
Nodes (32): 3.10 Register the topic in `ARCHITECTURE.md`, 3.1 Name the folder, 3.2 Copy the master, whole, 3.3 File-by-file: keep exactly as copied (the shared contracts), 3.4 File-by-file: adapt (the topic-specific content), 3.5 File-by-file: create fresh (only if your topic needs them), 3.6 Update `meta.json` (every field), 3.7 Update the new folder's `CLAUDE.md` (the pointer to root docs) (+24 more)

### Community 354 - "announce"
Cohesion: 0.14
...
### Community 356 - "reset"
Cohesion: 0.17
Nodes (21): drawCompare(), clamp(), computeCutDistances(), computeStringPath(), cutHeightAt(), drawDevelopment(), drawParallelDevelopment(), drawRadialDevelopment() (+13 more)

### Community 357 - "lineTypeRig.js"
Cohesion: 0.24
Nodes (11): createLabelManager(), createLineTypeRig(), cssColor(), GRID, ADR-0007, ADR-0018, ADR-0041, LW (+3 more)

### Community 358 - "problems.js"
Cohesion: 0.17
Nodes (13): ADR-0071, initProblemLibrary(), ADR-0062, ADR-0063, ENABLED_TIERS, enabledProblems(), EXCLUDED_TYPES, FIELD_LABELS (+5 more)

### Community 359 - "applyCompareSize"
Cohesion: 0.20
Nodes (11): createCompareSheet(), cssColor(), ADR-0004, ADR-0007, ADR-0012, ADR-0016, ADR-0034, ADR-0038 (+3 more)

### Community 360 - "Changelog"
Cohesion: 0.40
Nodes (4): 2026-07-17, 2026-07-18, 2026-07-20, Changelog

### Community 361 - "main.js"
Cohesion: 0.05
Nodes (54): ADR-0005, announce(), applyCompareSize(), compare, DEFAULT_CAMERA_POSITION, DEFAULT_CAMERA_TARGET, defaultSectionState(), defaultSolidData() (+46 more)
...
Cohesion: 0.17
Nodes (11): 3D engineering gotchas (read before writing rotation/unroll math), Architecture (non-negotiable), CLAUDE.md — Simatrix Engineering Graphics Viewer — Development of Surfaces, Cross-cutting rules, Geometry engine (restored from Module 2, byte-identical — ADR-009), Keeping Root Documents Current, Platform contract (required for Simatrix uploads), Project-wide documentation (read before cross-module tasks) (+3 more)

### Community 366 - "anim.js"
Cohesion: 0.14
Nodes (11): animate(), resume(), startLoop(), active, cancelAll(), easeCamera, easeDissolve, easeDraw (+3 more)

### Community 367 - "meshAnalyzer.js"
Cohesion: 0.27
Nodes (7): addEdge(), buildEdgeMap(), compareLattice(), Edge, Face, IDENTITY_ELEMENTS, vertexToken()
...
Cohesion: 0.15
Nodes (14): initProblemLibrary(), ADR-0063, ADR-0065, ADR-0070, ENABLED_TIERS, enabledProblems(), EXCLUDED_TYPES, FIELD_LABELS (+6 more)

### Community 370 - "setView"
Cohesion: 0.25
Nodes (17): tween(), animateFoldSwoop(), engageOrtho(), exitQuickView(), fitOrthoZoom(), fitOrthoZoomForView(), flatBoxFor(), orthoZoomForDist() (+9 more)

### Community 371 - "Changelog — Development of Surfaces (Module 3, Topic 2)"
Cohesion: 0.50
Nodes (3): 2026-07-18, 2026-07-20, Changelog — Development of Surfaces (Module 3, Topic 2)

### Community 372 - "lineRig.js"
Cohesion: 0.16
Nodes (9): createLabel(), ANGLE_OFFSET, AXIS_X_ANCHOR, AXIS_Y_ANCHOR, ADR-0018, PLANE_HP_ANCHOR, PLANE_VP_ANCHOR, LabelType (+1 more)

### Community 373 - "buildScene"
Cohesion: 0.19
Nodes (21): $(), closeTerm(), cueOrthoLock(), disarmReset(), enterWorkbench(), exitWorkbench(), goBack(), goNext() (+13 more)

### Community 374 - "anim.js"
Cohesion: 0.14
Nodes (12): applyProjectionMorph(), loop(), resume(), startLoop(), active, cancelAll(), easeCamera, easeDissolve (+4 more)

### Community 375 - "onboarding.js"
Cohesion: 0.40
Nodes (3): initOnboarding(), SPOTLIGHTS, TONE_CLASSES

### Community 376 - "rotationMethod.js"
Cohesion: 0.23
Nodes (9): bisectorAnchor(), ADR-0007, PLACEMENT, clamp01(), createRotationMethod(), cssColor(), ADR-0007, lc() (+1 more)

### Community 377 - "reset"
Cohesion: 0.19
Nodes (17): clearProjectionMorph(), clearQuickView(), contentBoxWorld(), driveFold(), engageOrtho(), fitOrthoZoom(), fitOrthoZoomForView(), flatSheetBox() (+9 more)

### Community 378 - "Changelog — Projection of Straight Lines · Types of Lines"
Cohesion: 0.07
Nodes (27): [0.1.0] — 2026-07-15 — Initial build, [0.1.1] — 2026-07-15 — De-lint pass (post-critique), [0.1.2] — 2026-07-15 — Polish pass (P2 backlog), [0.1.3] — 2026-07-15 — Fix: 2D Compare endpoint labels, [0.1.4] — 2026-07-15 — Fix: 3D True-Length annotation on the correct projection, [0.1.5] — 2026-07-20 — Fix: construction-aid token drift vs DESIGN.md §2.2, [0.1.6] — 2026-07-20 — Platform amber promotion + rounded workbench + stale comment fix, [0.1.7] — 2026-07-20 — Step-card typography normalized to Module 2 reference scale (+19 more)

### Community 379 - "restorePerspective"
Cohesion: 0.20
Nodes (17): clearProjectionMorph(), clearQuickView(), driveFold(), engageOrtho(), fitOrthoZoom(), fitOrthoZoomForView(), flatSheetBox(), frameStep() (+9 more)

### Community 380 - "lineSteps.js"
Cohesion: 0.14
Nodes (13): hasDialedWork(), defaultLineData(), deg(), LineCase, resolveLine(), STEPS, TERMS, initStepper() (+5 more)

### Community 381 - "traces.js"
Cohesion: 0.09
Nodes (27): enterTrace(), bisectorAnchor(), ADR-0007, PLACEMENT, computeTraces(), ADR-0007, ADR-0038, ADR-0053 (+19 more)

### Community 382 - "init"
Cohesion: 0.18
Nodes (10): injectCardChrome(), injectChrome(), injectLibraryChrome(), attachOrtho(), boot(), build(), buildRail(), readTokens() (+2 more)

### Community 383 - "LabelPlacement.js"
Cohesion: 0.20
Nodes (6): ANGLE_OFFSET, AXIS_X_ANCHOR, AXIS_Y_ANCHOR, ADR-0018, PLANE_HP_ANCHOR, PLANE_VP_ANCHOR

### Community 384 - "anim.js"
Cohesion: 0.14
Nodes (12): applyProjectionMorph(), loop(), resume(), startLoop(), active, cancelAll(), easeCamera, easeDissolve (+4 more)

### Community 385 - "lineTypesData.js"
Cohesion: 0.16
Nodes (11): contentBoxWorld(), defaultTypeData(), deg(), LineCase, resolveLine(), STEPS, TERMS, initStepper() (+3 more)

### Community 386 - "reset"
Cohesion: 0.20
Nodes (9): completeAndNext(), reset(), resetCamera(), setFirstAngleSymbol(), setRefLabelOpacity(), showToast(), initStepper(), ADR-0041 (+1 more)

### Community 387 - "enterCon"
Cohesion: 0.26
Nodes (12): commit(), disposeContent(), enterCon(), enterTL(), exitCon(), notifyStateChange(), rebuild(), runCon() (+4 more)

### Community 388 - "sheet2DLayout.js"
Cohesion: 0.24
Nodes (10): computeTraces(), ADR-0007, ADR-0038, ADR-0053, ADR-0072, ADR-0075, layout2D(), W() (+2 more)

### Community 389 - "LabelManager.js"
Cohesion: 0.60
Nodes (3): createLabel(), LabelType, STYLE

### Community 390 - "rebuild"
Cohesion: 0.26
Nodes (12): commit(), disposeContent(), enterCon(), enterRotation(), exitCon(), notifyStateChange(), rebuild(), runCon() (+4 more)

### Community 391 - "compareSheet.js"
Cohesion: 0.08
Nodes (34): createCompareSheet(), cssColor(), ADR-0004, ADR-0007, ADR-0012, ADR-0016, ADR-0034, ADR-0038 (+26 more)

### Community 392 - "Changelog — Projection of Straight Lines"
Cohesion: 0.13
Nodes (14): 2026-07-12 — Migration off `engine.js` to the standalone topic, COMPLETE (Phases 4A–4G, ADR-042), 2026-07-13 — Final annotation pass: balanced endpoint labels, icon-button layout, construction hierarchy, 2026-07-13 — Label-placement architecture: ONE centralized placement policy (`labelPlacement.js`), 2026-07-13 — Label-placement parity: reuse the Points `CHIP_OFFSET` standoff strategy, 2026-07-13 — Scene framing: restore the Points apparatus-tight philosophy (HP/VP extents 60→24), 2026-07-13 — Visual-parity pass: restore the clean orthographic sheet against the Points gold standard, 2026-07-15 — Remove vestigial Points leftovers + earlier UI-quality pass (impeccable), 2026-07-19 — Promoted to catalog topic 6; Problem Library doc un-staled; tokens reconciled (ADR-072) (+6 more)

### Community 393 - "CLAUDE.md — Simatrix · Projection of Straight Lines — Types of Lines"
Cohesion: 0.20
Nodes (9): Architecture — Module 2 orchestrator pattern (ADR-033), CLAUDE.md — Simatrix · Projection of Straight Lines — Types of Lines, File structure (as built), Keeping Root Documents Current, Non-negotiables inherited from the platform (apply unchanged), Project-wide documentation (read before cross-module tasks), SESSION DIGEST — [date] — [feature/task], Session Digest Protocol (+1 more)

### Community 394 - "announce"
Cohesion: 0.43
Nodes (8): $(), rebuildFromEdit(), sync(), wireControls(), announce(), editRebuild(), flowNote(), simFacade()

### Community 395 - "CLAUDE.md — Simatrix · Projection of Straight Lines"
Cohesion: 0.22
...
### Community 396 - "uiManager.js"
Cohesion: 0.32
Nodes (7): clamp(), DRIVERS, initUIManager(), ADR-0007, ADR-0017, ADR-0018, parseNumeric()

### Community 397 - "uiManager.js"
Cohesion: 0.32
Nodes (7): clamp(), DRIVERS, initUIManager(), ADR-0007, ADR-0017, ADR-0018, parseNumeric()

### Community 398 - "intro.js"
Cohesion: 0.43
Nodes (3): defaultPlaneData(), STEPS, TERMS

### Community 399 - "fill"
Cohesion: 0.33
Nodes (7): beginOverlay(), fill(), isSplit(), refillCompare(), s2Px(), s3Px(), updateLineRes()

### Community 400 - "armReset"
Cohesion: 0.47
Nodes (5): armReset(), clamp(), initUIManager(), parseNumeric(), SLIDERS

### Community 401 - "frameDefault"
Cohesion: 0.67
Nodes (4): contentBoxWorld(), fitPerspectiveDistance(), frameDefault(), reframeIfClipped()

## Knowledge Gaps
- **1591 isolated node(s):** `FEEDBACK`, `SYM`, `NOHALO`, `reduceMotion`, `DEF` (+1586 more)
...
- **Why does `armReset()` connect `armReset` to `announce`, `uiManager.js`, `uiManager.js`, `init`, `ADR Index & Compare View`, `announce`, `buildScene`, `main`, `terms`, `initUIManager`?**
  _High betweenness centrality (0.218) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `main` to `First-Angle Projection Scene`, `armReset`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `uiManager.js` to `armReset`, `pointData`?**
...
- **Should `Projection Orchestrator` be split into smaller, more focused modules?**
  _Cohesion score 0.13254901960784313 - nodes in this community are weakly interconnected._