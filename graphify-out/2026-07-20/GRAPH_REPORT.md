...
## Corpus Check
- 286 files · ~698,745 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3523 nodes · 5637 edges · 395 communities (187 shown, 208 thin omitted)
...
1. `Simatrix — Decisions (ADR Log)` - 75 edges
2. `$()` - 29 edges
3. `asg()` - 28 edges
4. `rebuild()` - 26 edges
5. `alb()` - 25 edges
...
## Communities (395 total, 208 thin omitted)

### Community 0 - "First-Angle Projection Scene"
Cohesion: 0.05
Nodes (62): animate(), applyMode(), applyProjectionMorph(), buildScene(), compare, computeEffectiveAngles(), contentBox(), createEdgeOverlay() (+54 more)
...
### Community 30 - "main"
Cohesion: 0.13
Nodes (13): init(), markBooted(), setupConnectorToggle(), setupMobileNotice(), initOnboarding(), SPOTLIGHTS, TONE_CLASSES, initProblemLibrary() (+5 more)
...
Cohesion: 0.19
Nodes (14): animateFold(), applyDimensionVisibility(), applyFoldVisual(), applyProfilePlaneVisibility(), disposeActiveProjection(), refreshProjections(), setDimensionsVisible(), setObjectOpacity() (+6 more)
...
Cohesion: 0.15
Nodes (11): handleResize(), init(), markBooted(), setupMobileNotice(), setupWizardToggle(), initOnboarding(), SPOTLIGHTS, TONE_CLASSES (+3 more)
...
Cohesion: 0.05
Nodes (52): applyCompareSize(), applyProjectionMorph(), CAMERA_POSITION, CAMERA_TARGET, compare, currentData, currentView, DEFAULT_VIEW (+44 more)
...
Cohesion: 0.08
Nodes (41): ADR-0061, addEdgeOverlay(), addProjectionViews(), addSectionPlaneVisual(), animate(), announce(), applySectionCut(), applyStageVisibility() (+33 more)
...
Cohesion: 0.15
Nodes (14): ADR-0071, ADR-0062, ADR-0063, ENABLED_TIERS, enabledProblems(), EXCLUDED_TYPES, FIELD_LABELS, groupByTier() (+6 more)
...
Cohesion: 0.09
Nodes (22): createLabel(), createLabelManager(), ANGLE_OFFSET, AXIS_X_ANCHOR, AXIS_Y_ANCHOR, ADR-0018, PLANE_HP_ANCHOR, PLANE_VP_ANCHOR (+14 more)
...
### Community 377 - "reset"
Cohesion: 0.14
Nodes (22): announce(), clearProjectionMorph(), clearQuickView(), completeAndNext(), driveFold(), engageOrtho(), fitOrthoZoom(), fitOrthoZoomForView() (+14 more)

### Community 378 - "Changelog — Projection of Straight Lines · Types of Lines"
Cohesion: 0.08
Nodes (25): [0.1.0] — 2026-07-15 — Initial build, [0.1.1] — 2026-07-15 — De-lint pass (post-critique), [0.1.2] — 2026-07-15 — Polish pass (P2 backlog), [0.1.3] — 2026-07-15 — Fix: 2D Compare endpoint labels, [0.1.4] — 2026-07-15 — Fix: 3D True-Length annotation on the correct projection, [0.1.5] — 2026-07-20 — Fix: construction-aid token drift vs DESIGN.md §2.2, [0.1.6] — 2026-07-20 — Platform amber promotion + rounded workbench + stale comment fix, [0.1.7] — 2026-07-20 — Step-card typography normalized to Module 2 reference scale (+17 more)
...
Cohesion: 0.16
Nodes (11): contentBoxWorld(), deg(), LineCase, resolveLine(), STEPS, TERMS, ADR-0007, ADR-0017 (+3 more)

### Community 381 - "traces.js"
Cohesion: 0.10
Nodes (24): enterTrace(), bisectorAnchor(), ADR-0007, PLACEMENT, computeTraces(), ADR-0007, ADR-0038, layout2D() (+16 more)

### Community 382 - "init"
Cohesion: 0.10
Nodes (19): buildScene(), computeRegions(), cssColor(), cueOrthoLock(), handleResize(), init(), markBooted(), pinCanvasSize() (+11 more)
...
Cohesion: 0.36
Nodes (7): computeTraces(), ADR-0007, ADR-0038, layout2D(), W(), xAtY(), yAtX()
...
## Knowledge Gaps
- **1582 isolated node(s):** `FEEDBACK`, `SYM`, `NOHALO`, `reduceMotion`, `DEF` (+1577 more)
...
- **Why does `initUIManager()` connect `uiManager.js` to `buildScene`, `init`, `pointData`?**
