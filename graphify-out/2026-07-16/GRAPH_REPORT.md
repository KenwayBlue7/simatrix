...
## Corpus Check
- 192 files · ~498,437 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2532 nodes · 3977 edges · 350 communities (141 shown, 209 thin omitted)
...
## Communities (350 total, 209 thin omitted)
...
Cohesion: 0.05
Nodes (37): animate(), applyProjectionMorph(), compare, DEFAULT_CAMERA_POSITION, DEFAULT_CAMERA_TARGET, DEFAULT_VIEW_DIR, driverHomes, FLAT_VIEW_UP (+29 more)
...
Cohesion: 0.17
Nodes (27): $(), rebuildFromEdit(), wireControls(), announce(), closeTerm(), cueOrthoLock(), disarmReset(), editRebuild() (+19 more)
...
### Community 39 - "main"
Cohesion: 0.12
Nodes (25): easeCamera, animateFold(), announceState(), buildCtx(), clearProjectionMorph(), declutterChipLabels(), foldBack(), foldForward() (+17 more)
...
### Community 43 - "anim"
Cohesion: 0.11
Nodes (20): announce(), drawCompare(), handleResize(), init(), markBooted(), remeasureAfterReflow(), resetCompareView(), setConnectorsVisible() (+12 more)
...
Cohesion: 0.40
Nodes (6): applyCompareSize(), ensureWorkbenchRail(), enterWorkbench(), exitWorkbench(), isWorkbenchViewport(), syncRailToggleState()
...
Cohesion: 0.24
Nodes (10): $(), syncUI(), HPVT(), QNAME, sync(), VPVT(), wireControls(), setRange() (+2 more)
...
## Knowledge Gaps
- **1163 isolated node(s):** `FEEDBACK`, `SYM`, `NOHALO`, `reduceMotion`, `DEF` (+1158 more)
...
- **Why does `armReset()` connect `announce` to `ADR Index & Compare View`, `main`, `lineDrawer`, `terms`, `initUIManager`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `main` to `First-Angle Projection Scene`, `announce`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `terms` to `announce`, `Scene Boot & Camera`, `main`?**
