# Graph Report - Simatrix  (2026-07-15)

## Corpus Check
- 192 files · ~483,206 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2486 nodes · 3896 edges · 348 communities (139 shown, 209 thin omitted)
...
1. `Simatrix — Decisions (ADR Log)` - 52 edges
2. `$()` - 29 edges
3. `asg()` - 28 edges
4. `rebuild()` - 26 edges
5. `alb()` - 25 edges
...
## Communities (348 total, 209 thin omitted)

### Community 0 - "First-Angle Projection Scene"
Cohesion: 0.05
Nodes (54): ADR-0034, animate(), applyMode(), applyProjectionMorph(), buildScene(), compare, computeEffectiveAngles(), createEdgeOverlay() (+46 more)
...
Cohesion: 0.21
Nodes (20): buildAnimScene(), draw3D(), drawStage(), firstAngleSymbol(), SYM, draw3D(), resolve(), draw3D() (+12 more)
...
Cohesion: 0.07
Nodes (31): ADR-0021, CAMERA_POSE, compare, currentData, currentView, fitOrthoZoom(), fitOrthoZoomForView(), ADR-0004 (+23 more)
...
Cohesion: 0.07
Nodes (32): tick(), injectCardChrome(), injectChrome(), injectLibraryChrome(), applyProjectionMorph(), area, attachOrtho(), boot() (+24 more)
...
Cohesion: 0.13
Nodes (22): $(), afterRebuild(), draw3D(), FEEDBACK, mark(), wireControls(), draw3D(), FOCUS (+14 more)
...
Cohesion: 0.31
Nodes (6): QNAME, FIELD_LABELS, PROBLEMS, TIERS, STEPS, TERMS

### Community 28 - "lineDrawer"
Cohesion: 0.13
Nodes (35): $(), $(), rebuildFromEdit(), syncUI(), sync(), wireControls(), announce(), closeTerm() (+27 more)

### Community 29 - "main"
Cohesion: 0.24
Nodes (19): answerSheetBox(), clearProjectionMorph(), contentBox(), engageOrtho(), fitOrthoZoom(), fitPerspectiveDistance(), flattenedViewBox(), frameToSolid() (+11 more)
...
### Community 39 - "main"
Cohesion: 0.12
Nodes (24): announceState(), beginOverlay(), buildCtx(), declutterChipLabels(), fill(), foldBack(), foldForward(), notifyStateChange() (+16 more)
...
Cohesion: 0.26
Nodes (22): angle3(), arc(), asgBold(), buildAnimScene(), conMarker(), draw2D(), draw3D(), drawSheetViews() (+14 more)
...
Cohesion: 0.20
Nodes (21): tween(), animateFoldSwoop(), clearProjectionMorph(), contentBoxWorld(), engageOrtho(), exitQuickView(), fitOrthoZoom(), fitOrthoZoomForView() (+13 more)

### Community 58 - "wireControls"
Cohesion: 0.27
...
### Community 117 - "armReset"
Cohesion: 0.47
Nodes (5): armReset(), clamp(), initUIManager(), parseNumeric(), SLIDERS

### Community 118 - "frameDefault"
Cohesion: 0.17
Nodes (10): active, cancelAll(), easeCamera, easeDissolve, easeDraw, easeFold, easeStandard, animateFold() (+2 more)
...
Cohesion: 0.25
Nodes (11): applyCompareSize(), drawCompare(), ensureWorkbenchRail(), enterWorkbench(), exitWorkbench(), handleResize(), isWorkbenchViewport(), remeasureAfterReflow() (+3 more)

### Community 121 - "Critique — Orthographic Projection Guided Stepper (`index.html`)"
Cohesion: 0.40
...
Cohesion: 0.33
Nodes (5): 2026-06-16, 2026-07-02, 2026-07-09, 2026-07-15, Changelog
...
Cohesion: 0.15
Nodes (13): commit(), contentBoxWorld(), disposeContent(), flatSheetBox(), hasDialedWork(), notifyStateChange(), rebuild(), viewportSize() (+5 more)
...
Cohesion: 0.22
Nodes (10): $(), HPVT(), QNAME, sync(), VPVT(), wireControls(), defaultPointData(), QuadrantType (+2 more)
...
## Knowledge Gaps
- **1135 isolated node(s):** `FEEDBACK`, `SYM`, `NOHALO`, `reduceMotion`, `DEF` (+1130 more)
...
- **Why does `armReset()` connect `armReset` to `anim`, `ADR Index & Compare View`, `lineDrawer`, `terms`, `main`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `terms` to `armReset`, `Scene Boot & Camera`, `main`?**
