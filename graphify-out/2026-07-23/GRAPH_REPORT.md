...
## Corpus Check
- 293 files · ~704,889 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3563 nodes · 5686 edges · 387 communities (179 shown, 208 thin omitted)
...
1. `Simatrix — Decisions (ADR Log)` - 77 edges
2. `$()` - 29 edges
3. `asg()` - 28 edges
4. `rebuild()` - 26 edges
5. `alb()` - 25 edges
...
## Communities (387 total, 208 thin omitted)
...
Cohesion: 0.08
Nodes (56): $(), applyTLState(), arc(), beginConScene(), buildTLScene(), buildTraceScene(), CALM_GRID, clamp01() (+48 more)
...
Cohesion: 0.05
Nodes (88): $(), active, cancelAll(), easeCamera, easeDissolve, easeDraw, easeFold, easeStandard (+80 more)
...
Cohesion: 0.10
Nodes (24): announce(), applyCompareSize(), buildScene(), cssColor(), cueOrthoLock(), ensureWorkbenchRail(), enterWorkbench(), exitWorkbench() (+16 more)
...
Cohesion: 0.27
Nodes (12): buildPrismGeometry(), createGenericPrism(), cssColor(), rootStyle, buildPyramidGeometry(), rootStyle, alignmentOffset(), apothem() (+4 more)
...
Cohesion: 0.05
Nodes (43): applyProjectionMorph(), CAMERA_POSITION, CAMERA_TARGET, compare, currentData, currentView, DEFAULT_VIEW, ensureSheetRenderer() (+35 more)
...
Cohesion: 0.12
Nodes (16): 2026-06-27, 2026-06-28, 2026-06-29, 2026-07-02, 2026-07-03, 2026-07-09, 2026-07-10, 2026-07-11 (+8 more)
...
Cohesion: 0.05
Nodes (51): applyCompareSize(), CAMERA_POSITION, CAMERA_TARGET, compare, CON_DOCK_CONTROLS, CON_LABELS, currentData, currentView (+43 more)
...
Cohesion: 0.10
Nodes (20): buildScene(), cssColor(), cueOrthoLock(), handleResize(), init(), markBooted(), pinCanvasSize(), setupMobileNotice() (+12 more)
...
Cohesion: 0.17
Nodes (16): addSectionPlaneVisual(), applySectionCut(), buildScene(), buildSectionPlaneWorld(), createEdgeOverlay(), createSolidMesh(), cssColor(), cssVar() (+8 more)
...
Cohesion: 0.12
Nodes (21): createCompareSheet(), cssColor(), ADR-0004, ADR-0007, ADR-0012, ADR-0016, ADR-0034, ADR-0041 (+13 more)
...
Cohesion: 0.12
Nodes (19): bisectorAnchor(), ADR-0007, PLACEMENT, clamp01(), createRotationMethod(), cssColor(), ADR-0007, lc() (+11 more)
...
Cohesion: 0.05
Nodes (37): [0.1.0] — 2026-07-15 — Initial build, [0.1.10] — 2026-07-21 — Own-canvas 2D Compare sheet; ADR-037 floating-card workbench; Rotation Method runs in the split, [0.1.11] — 2026-07-22 — Dashed hidden-edge lines tightened to Module 2's visual standard, [0.1.12] — 2026-07-23 — Compare 2D drawing panel hairline border removed, [0.1.13] — 2026-07-23 — Compare panel hairline border: real fix (canvas-drawn frame, not CSS), [0.1.1] — 2026-07-15 — De-lint pass (post-critique), [0.1.2] — 2026-07-15 — Polish pass (P2 backlog), [0.1.3] — 2026-07-15 — Fix: 2D Compare endpoint labels (+29 more)

### Community 379 - "restorePerspective"
Cohesion: 0.21
Nodes (16): clearProjectionMorph(), clearQuickView(), contentBoxWorld(), driveFold(), engageOrtho(), fitOrthoZoom(), fitOrthoZoomForView(), frameStep() (+8 more)

### Community 380 - "lineSteps.js"
Cohesion: 0.16
Nodes (11): deg(), LineCase, resolveLine(), STEPS, TERMS, initStepper(), ADR-0007, ADR-0017 (+3 more)

### Community 381 - "traces.js"
Cohesion: 0.09
Nodes (27): enterTL(), bisectorAnchor(), ADR-0007, PLACEMENT, computeTraces(), ADR-0007, ADR-0038, ADR-0053 (+19 more)

### Community 383 - "LabelPlacement.js"
Cohesion: 0.10
Nodes (20): createLabel(), createLabelManager(), ANGLE_OFFSET, AXIS_X_ANCHOR, AXIS_Y_ANCHOR, ADR-0018, PLANE_HP_ANCHOR, PLANE_VP_ANCHOR (+12 more)

### Community 385 - "lineTypesData.js"
Cohesion: 0.16
Nodes (12): flatSheetBox(), reset(), defaultTypeData(), deg(), LineCase, resolveLine(), STEPS, TERMS (+4 more)

### Community 387 - "enterCon"
Cohesion: 0.23
Nodes (12): commit(), disposeContent(), ensureCompareForCon(), enterCon(), enterTrace(), notifyStateChange(), rebuild(), runCon() (+4 more)

### Community 390 - "rebuild"
Cohesion: 0.23
Nodes (13): commit(), disposeContent(), ensureCompareForCon(), enterCon(), enterRotation(), exitCon(), notifyStateChange(), rebuild() (+5 more)

### Community 391 - "compareSheet.js"
Cohesion: 0.08
Nodes (34): createCompareSheet(), cssColor(), ADR-0004, ADR-0007, ADR-0012, ADR-0016, ADR-0034, ADR-0041 (+26 more)

### Community 392 - "Changelog — Projection of Straight Lines"
Cohesion: 0.10
Nodes (20): 2026-07-12 — Migration off `engine.js` to the standalone topic, COMPLETE (Phases 4A–4G, ADR-042), 2026-07-13 — Final annotation pass: balanced endpoint labels, icon-button layout, construction hierarchy, 2026-07-13 — Label-placement architecture: ONE centralized placement policy (`labelPlacement.js`), 2026-07-13 — Label-placement parity: reuse the Points `CHIP_OFFSET` standoff strategy, 2026-07-13 — Scene framing: restore the Points apparatus-tight philosophy (HP/VP extents 60→24), 2026-07-13 — Visual-parity pass: restore the clean orthographic sheet against the Points gold standard, 2026-07-15 — Remove vestigial Points leftovers + earlier UI-quality pass (impeccable), 2026-07-19 — Promoted to catalog topic 6; Problem Library doc un-staled; tokens reconciled (ADR-072) (+12 more)
...
## Knowledge Gaps
- **1608 isolated node(s):** `FEEDBACK`, `SYM`, `NOHALO`, `reduceMotion`, `DEF` (+1603 more)
...
- **Why does `armReset()` connect `buildScene` to `uiManager.js`, `init`, `ADR Index & Compare View`, `announce`, `main`, `wireControls`, `terms`, `initUIManager`?**
  _High betweenness centrality (0.218) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `main` to `First-Angle Projection Scene`, `buildScene`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `wireControls` to `buildScene`, `pointData`?**
