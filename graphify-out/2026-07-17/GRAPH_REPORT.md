# Graph Report - Simatrix  (2026-07-17)

## Corpus Check
- 216 files · ~552,022 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2761 nodes · 4344 edges · 363 communities (154 shown, 209 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 118 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `42fc28a5`
...
## Communities (363 total, 209 thin omitted)

### Community 0 - "First-Angle Projection Scene"
Cohesion: 0.05
Nodes (57): animate(), applyMode(), applyProjectionMorph(), buildScene(), compare, computeEffectiveAngles(), contentBox(), createEdgeOverlay() (+49 more)

### Community 1 - "Fold Animation Engine"
Cohesion: 0.05
Nodes (58): animate(), applyMode(), applyProjectionMorph(), buildScene(), compare, computeEffectiveAngles(), createEdgeOverlay(), cssColor() (+50 more)

### Community 2 - "Projection Orchestrator"
Cohesion: 0.14
Nodes (42): buildAnimScene(), draw3D(), drawStage(), firstAngleSymbol(), SYM, draw3D(), buildAnimScene(), draw2D() (+34 more)
...
Cohesion: 0.09
Nodes (43): angle3(), arc(), asgBold(), beginConScene(), buildTLScene(), buildTraceScene(), CALM_GRID, clamp01() (+35 more)

### Community 5 - "Scene Boot & Camera"
Cohesion: 0.05
Nodes (44): ADR-0021, animate(), applyProjectionMorph(), CAMERA_POSE, compare, currentData, currentView, fitOrthoZoom() (+36 more)
...
Cohesion: 0.05
Nodes (37): 1. Purpose and scope of this file, 2.1 The token table (verified against code), 2.2 Module-1 construction-aid encodings (Lines sim), 2.3 The named colour rules (binding everywhere), 2. Color system, 3.1 Where the fonts are hosted, 3.2 When each font is used (hierarchy), 3.3 The named type rules (+29 more)
...
### Community 31 - "main"
Cohesion: 0.15
Nodes (19): announce(), applyCompareSize(), completeAndNext(), ensureWorkbenchRail(), enterWorkbench(), exitWorkbench(), handleResize(), isWorkbenchViewport() (+11 more)
...
Cohesion: 0.14
Nodes (11): init(), markBooted(), setupMobileNotice(), setupQuickViews(), initOnboarding(), SPOTLIGHTS, TONE_CLASSES, initProblemLibrary() (+3 more)
...
Cohesion: 0.15
Nodes (12): 2026-06-27, 2026-06-28, 2026-06-29, 2026-07-02, 2026-07-03, 2026-07-09, 2026-07-10, 2026-07-11 (+4 more)
...
Cohesion: 0.47
Nodes (5): ADR-0048, clamp(), initUIManager(), parseNumeric(), SECTION_SLIDERS
...
Cohesion: 0.08
Nodes (44): ADR-0009, addEdgeOverlay(), addSectionPlaneVisual(), announce(), applySectionCut(), applyStageVisibility(), buildScene(), buildSectionPlaneWorld() (+36 more)
...
Cohesion: 0.22
Nodes (15): createSolidMesh(), buildPrismGeometry(), createGenericPrism(), cssColor(), rootStyle, buildPyramidGeometry(), createGenericPyramid(), cssColor() (+7 more)
...
Cohesion: 0.17
Nodes (10): animate(), active, cancelAll(), easeCamera, easeDissolve, easeDraw, easeFold, easeStandard (+2 more)
...
Cohesion: 0.33
Nodes (5): ADR-M3T1-001: Section cutting is a hand-authored single-plane triangle clipper, not a CSG library, ADR-M3T1-002: Section-plane state lives outside ShapeData, beside it in main.js, ADR-M3T1-003: projectionDrawer.js is a byte-identical Module2 copy; all section drawing lives in a new leaf module, ADR-M3T1-004: The true shape is an in-scene world-scale sheet plus a camera tween, not an auxiliary camera viewport, DECISIONS.md — Sections of Solids (topic-local ADR log)

### Community 361 - "announce"
Cohesion: 0.43
Nodes (8): $(), rebuildFromEdit(), sync(), wireControls(), announce(), editRebuild(), flowNote(), simFacade()

### Community 362 - "pointProblems.js"
Cohesion: 0.33
Nodes (5): FIELD_LABELS, ADR-0015, ADR-0018, PROBLEMS, TIERS

## Knowledge Gaps
- **1258 isolated node(s):** `FEEDBACK`, `SYM`, `NOHALO`, `reduceMotion`, `DEF` (+1253 more)
...
- **Why does `armReset()` connect `terms` to `announce`, `ADR Index & Compare View`, `layout`, `main`, `lineDrawer`, `initUIManager`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `main` to `First-Angle Projection Scene`, `terms`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `initUIManager()` connect `terms` to `problemLibrary.js`, `Scene Boot & Camera`?**
