...
// The family-default 200x140 (Topic 1.1's canvas), NOT Topic 2.1's enlarged 240x190 — that
// enlargement was sized for the roulette family's epicycloid/hypocycloid base circles (up
// to 100mm radius); involute geometry never needed it. Topic 2.1's own INVOLUTE_BUDGET sub-
// rect only ever used 200x140 worth of space inside its larger canvas (ADR-080's own note).
const BASE_W = 200;
const BASE_H = 140;
