...
//   1. Choose  — pick one of the four constructions (a picker, not a wall of controls).
...
// constructions/src/stepper.js) — only the STEPS copy below (picker count) is topic-own.
//
// Layering (CLAUDE.md): leaf module. Imports nothing; main.js injects `sim`.

const STEPS = [
  { n: 1, title: 'Learn a Construction', lead: 'Pick one of the four tangent-arc constructions to build.' },
  { n: 2, title: 'Given', lead: 'This is what the construction starts from — adjust its values below.' },
