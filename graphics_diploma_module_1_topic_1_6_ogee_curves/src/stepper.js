...
// by the same pattern, every later topic in this syllabus track) shares:
//   1. Choose  — pick one of the nine constructions (a picker, not a wall of controls).
//   2. Given   — the construction's starting element(s), tied to a live numeric value.
//   3. Construct — the compass/straightedge moves resolve step by step (replayable).
...
const STEPS = [
  { n: 1, title: 'Choose a Curve', lead: 'Pick one of the two ogee (reverse) curve constructions to build.' },
  { n: 2, title: 'Given', lead: 'This is what the construction starts from — adjust a value below, or drag the handle directly in the drawing.' },
  { n: 3, title: 'Construct', lead: 'Press Play to watch the compass-and-straightedge moves resolve, one at a time.' },
