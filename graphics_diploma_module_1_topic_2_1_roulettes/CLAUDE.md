...
> Helix, 2.4 Involutes — the latter split out of this topic per ADR-080). Topic 2 sits **beside**
...
`../graphics_diploma_module_1_topic_2_4_involutes`, per ADR-080: an involute is generated by a
...
**Involute of a circle/polygon — split out (ADR-080).** This topic originally also carried a
