...
// This topic's canvas is 240x190, not Topic 1.1's 200x140 — the epicycloid/hypocycloid
// constructions carry a base circle up to 100mm radius (200mm across) plus the rolling
// circle's own extent, which does not fit the smaller family-default canvas at a readable
// scale (constructions.js's own INFERRED note).
const BASE_W = 240;
const BASE_H = 190;
