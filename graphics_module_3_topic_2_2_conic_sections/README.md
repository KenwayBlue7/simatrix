...
- **The cone IS cut away, and the removed material is kept as a faint ghost.** The ghost is not decoration: without it a steep tilt leaves a stump no learner would call a cone, and a hyperbola's second branch leaves with the nappe that carried it (ADR-088, superseding ADR-140 · RULES.md §3.41).
