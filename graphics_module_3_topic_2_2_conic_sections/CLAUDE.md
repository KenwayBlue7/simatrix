...
face is a real face of a real solid (ADR-088, superseding ADR-085). The material the cut removed is
...
three answered with the syllabus constructions plus the four new ones (ADR-135).
...
textbook rule arrive in Step 3 (ADR-086), so the learner is told *why*, not just *what* — but only
