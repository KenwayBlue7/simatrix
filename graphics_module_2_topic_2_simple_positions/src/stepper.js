...
//   2. Position & turn            5. Add side view (reveal PP)
...
const STEPS = [
  ...
  },
  {
    n: 2,
    title: 'Position & turn',
    lead: 'Now place the solid: set how far its base sits from the HP and from the VP, then turn it about its own axis — spin it freely, or orient a corner or edge to the VP. A simple position keeps the axis perpendicular to its resting plane, so this never tilts it; the views you draw next depend on where it sits and how it faces.',
  },
  {
    n: 3,
