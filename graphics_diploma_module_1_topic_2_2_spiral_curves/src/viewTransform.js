...
// This topic's canvas is 240x190, matching Topic 2.1 (not Topic 1.1's 200x140) — a
// logarithmic spiral's greatest radius runs up to 150mm, needing the same headroom
// Topic 2.1's epicycloid/hypocycloid constructions established this canvas size for.
const BASE_W = 240;
const BASE_H = 190;
