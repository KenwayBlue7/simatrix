...
// shares:
//   1. Choose  — this topic has one construction (the spiral engine, both growth laws), so
//      step 1 is a single-item picker — kept for structural consistency with every other
//      topic's wizard rather than special-casing a 3-step variant for this one topic.
//   2. Given   — the growth-law toggle plus the active law's measurements.
//   3. Construct — the radius vector sweeps from the pole; scrub Roll Angle or press Play.
...
const STEPS = [
  { n: 1, title: 'Choose a Curve', lead: 'One engine, two growth laws — pick Spiral Curves to begin.' },
  { n: 2, title: 'Given', lead: 'Pick a growth law, then set its measurements below.' },
  { n: 3, title: 'Construct', lead: 'Scrub the Roll Angle slider or press Play to sweep the radius vector, then watch the tangent/normal resolve.' },
