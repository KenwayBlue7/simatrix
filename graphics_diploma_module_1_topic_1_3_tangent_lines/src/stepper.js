...
//   1. Choose  — pick one of the three constructions (a picker, not a wall of controls).
...
//
// Mechanics copied verbatim from Topic 1.1/1.2 — only STEPS[0]'s lead text (construction
// count) is this topic's own.
//
// Layering (CLAUDE.md): leaf module. Imports nothing; main.js injects `sim`.

const STEPS = [
  { n: 1, title: 'Learn a Construction', lead: 'Pick one of the three constructions to build.' },
