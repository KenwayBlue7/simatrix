...
//
// Mechanics copied verbatim from Topic 1.1/1.2 (graphics_diploma_module_1_topic_1_1_basic_
...
export const TERMS = {
  tangent: 'A straight line that touches a curve at exactly one point, without crossing it.',
  'tangency-point': 'The single point where a tangent line actually touches the circle it was built to meet — every construction in this topic must mark and label it.',
  'external-tangent': "A common tangent to two circles that does NOT cross the line joining their centres — both circles sit on the SAME side of it.",
  'internal-tangent': "A common tangent to two circles that DOES cross the line joining their centres, passing between the circles — each circle sits on its OWN side of it.",
};
