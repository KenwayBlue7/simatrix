// Orchestrator — Diploma Engineering Graphics, Module 1 Topic 1.3: Tangent Lines.
//
...
//
// Copied from Topic 1.1's main.js — orchestrator shape, rebuild() funnel, simController
// contract, render loop, wizard-toggle, and Verify-step actions all unchanged. Unlike
// Topic 1.2, this topic has no cross-construction toggle param (external/internal common
// tangents are two separate picker items, not one construction with a mode switch), so
// `state.params` stays plain numbers — no `mode` default needed here.
//
