...
//
// Mechanics copied verbatim from Topic 1.1/1.2/1.3 — only the TERMS data below is this
// topic's own.
//
...
export const TERMS = {
  'regular-polygon': 'A closed shape whose sides are all the same length and whose angles are all equal — a regular pentagon, hexagon, or any n-gon.',
  circumcentre: 'The single point equally distant from every vertex of a polygon — the centre of the circle that passes through all of them.',
  constructible: 'Buildable with only a compass and straightedge, no protractor — true for a pentagon or hexagon, but not for most polygons (a regular 7-, 9-, or 11-sided figure, for instance, cannot be built this way at all).',
};
