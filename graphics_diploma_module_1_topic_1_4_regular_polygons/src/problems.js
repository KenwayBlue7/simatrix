...
export const PROBLEMS = [
  {
    id: 'pentagon-40-angle',
    tier: 'practice',
    constructionId: 'pentagon',
    statement: 'Construct a regular pentagon of side 40 mm using the 54° angle method.',
    target: { side: 40 },
    tolerance: { side: 1 },
    hints: [
      'Set the Side length slider to 40 mm.',
      'On the Construct step, choose the "54° Angle + Circle" method.',
      'Press Play, then check all five sides measure 40 mm and every interior angle is 108°.',
    ],
  },
  {
    id: 'pentagon-40-circles',
    tier: 'practice',
    constructionId: 'pentagon',
    statement: 'Construct the same 40 mm pentagon again, this time using the two-circles-and-an-arc method.',
    target: { side: 40 },
    tolerance: { side: 1 },
    hints: [
      'Side length stays 40 mm.',
  ...
  },
  {
    ...
    tier: 'challenge',
    constructionId: 'pentagon',
    statement: 'Construct the same 40 mm pentagon a third way, using only three compass arcs (no protractor, no full circles).',
    target: { side: 40 },
    tolerance: { side: 1 },
    hints: [
      'Side length stays 40 mm.',
  ...
  },
  {
    ...
    statement: 'Construct a regular hexagon of side 30 mm using the 60° lines method.',
    target: { side: 30 },
    tolerance: { side: 1 },
    hints: [
      'Set the Side length slider to 30 mm.',
      'Choose the "60° Lines" method.',
      'A hexagon’s circumradius always equals its side — check the distance from the centre to any vertex reads 30 mm too.',
    ],
  },
  {
    id: 'hexagon-30-compass',
    tier: 'practice',
    constructionId: 'hexagon',
    statement: 'Construct the same 30 mm hexagon again using only a compass, no protractor.',
    target: { side: 30 },
    tolerance: { side: 1 },
    hints: [
      'Side length stays 30 mm.',
      'Switch the method to "Compass + Circle".',
      'Same hexagon, found without ever measuring an angle.',
    ],
  },
  {
    id: 'heptagon-25-semicircle',
    tier: 'challenge',
    constructionId: 'ngon',
    statement: 'Construct a regular heptagon (7 sides) of side 25 mm using the semicircle-division method.',
    target: { side: 25, n: 7 },
    tolerance: { side: 1, n: 0 },
    hints: [
      'Set the Side length slider to 25 mm and Number of sides to 7.',
  ...
  {
    id: 'octagon-25-bisector',
    tier: 'challenge',
    constructionId: 'ngon',
    statement: 'Construct a regular octagon (8 sides) of side 25 mm using the perpendicular-bisector method.',
    target: { side: 25, n: 8 },
    tolerance: { side: 1, n: 0 },
    hints: [
      'Set the Side length slider to 25 mm and Number of sides to 8.',
  ...
  },
  {
    ...
    tier: 'challenge',
    constructionId: 'hexagon',
    statement: 'Applied problem: a pentagon and a hexagon share a common side of 40 mm. Construct the hexagon first, then switch to the pentagon and build it at the same 40 mm side length.',
    target: { side: 40 },
    tolerance: { side: 1 },
    hints: [
      'This loads the hexagon — set Side length to 40 mm, then build it with either method.',
      'Then open the picker again, choose Regular Pentagon, and set its side to 40 mm too.',
      'Imagine both shapes drawn on the same 40 mm edge — this is how a pentagon-and-hexagon combination tile is laid out on a drawing board.',
    ],
  },
];
