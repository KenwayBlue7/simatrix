# Graph Report - Module2  (2026-08-12)

## Corpus Check
- 29 files · ~113,757 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 465 nodes · 868 edges · 27 communities (23 shown, 4 thin omitted)
...
### Community 2 - "main.js"
Cohesion: 0.03
Nodes (56): ADR-0034, ADR-0037, ADR-0038, ADR-0052, ADR-0053, ADR-0054, ADR-0055, ADR-0056 (+48 more)
...
### Community 4 - "setView"
Cohesion: 0.19
Nodes (22): announce(), answerSheetBox(), clearProjectionMorph(), contentBox(), engageOrtho(), fitOrthoZoom(), fitPerspectiveDistance(), flattenedViewBox() (+14 more)

### Community 5 - "init"
Cohesion: 0.08
Nodes (24): init(), markBooted(), setupConnectorToggle(), setupMobileNotice(), initMethodController(), ADR-0084, ADR-0085, ADR-0087 (+16 more)
...
### Community 8 - "rebuild"
Cohesion: 0.17
Nodes (15): applyMode(), beginShowMethod(), computeEffectiveAngles(), computeSeating(), inclinationStageCount(), isPyramidType(), methodCanRun(), orientationAngle() (+7 more)
...
Cohesion: 0.10
Nodes (36): animateFold(), applyDimensionVisibility(), applyFoldVisual(), applyProfilePlaneVisibility(), disposeActiveProjection(), drawCompare(), exitMethodPose(), handleResize() (+28 more)
...
Cohesion: 0.10
Nodes (19): 2026-06-16, 2026-07-02, 2026-07-09, 2026-07-15, 2026-07-16, 2026-07-20, 2026-07-25, 2026-07-27 (+11 more)

### Community 20 - "reset"
Cohesion: 0.11
Nodes (28): abortShowMethod(), applyMethodPose(), cssVar(), drawMethodGhost(), drawMethodLabels(), drawMethodSheet(), drawMethodView(), endShowMethod() (+20 more)

### Community 21 - "startLoop"
Cohesion: 0.14
Nodes (13): completeAndNext(), reset(), resetCamera(), setFirstAngleSymbol(), setRefLabelOpacity(), showToast(), initStepper(), ADR-0041 (+5 more)

### Community 22 - "projectSet"
Cohesion: 0.50
Nodes (5): methodContentBeats(), methodFlattenHP(), methodFlattenVP(), methodQuantize(), methodSegmentKeys()

### Community 23 - "projectSet"
Cohesion: 0.29
Nodes (7): axisInclinations(), formatSetLabel(), harvestLabelGroup(), harvestLineGroup(), harvestTriGroup(), projectSet(), viewportSize()

## Knowledge Gaps
- **191 isolated node(s):** `rootStyle`, `DEFAULT_CAMERA_POSITION`, `DEFAULT_CAMERA_TARGET`, `DEFAULT_VIEW_DIR`, `QUICK_VIEWS` (+186 more)
...
- **Why does `drawProjections()` connect `projectionDrawer.js` to `main.js`, `refreshProjections`, `projectSet`?**
