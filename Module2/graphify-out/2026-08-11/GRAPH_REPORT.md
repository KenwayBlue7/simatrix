...
## Corpus Check
- 29 files · ~112,366 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 461 nodes · 861 edges · 24 communities (23 shown, 1 thin omitted)
...
### Community 5 - "init"
Cohesion: 0.06
Nodes (32): init(), markBooted(), setupConnectorToggle(), setupMobileNotice(), initMethodController(), ADR-0084, ADR-0085, ADR-0087 (+24 more)
...
### Community 8 - "rebuild"
Cohesion: 0.16
Nodes (16): applyMode(), computeEffectiveAngles(), computeSeating(), isPyramidType(), notifyStateChange(), orientationAngle(), positionRefLabels(), projectSequentialBothPlanesPose() (+8 more)
...
Cohesion: 0.16
Nodes (14): announce(), completeAndNext(), queueRedraw(), reset(), resetCamera(), resetCompareView(), setConnectorsVisible(), setFirstAngleSymbol() (+6 more)
...
Cohesion: 0.29
Nodes (7): buildScene(), createEdgeOverlay(), cssColor(), cueOrthoLock(), makePlaneLabel(), makeViewLabel(), initVertexLabeler()
...
Cohesion: 0.11
Nodes (29): animateFold(), applyDimensionVisibility(), applyFoldVisual(), applyProfilePlaneVisibility(), disposeActiveProjection(), drawCompare(), exitMethodPose(), handleResize() (+21 more)
...
Cohesion: 0.11
Nodes (17): 2026-06-16, 2026-07-02, 2026-07-09, 2026-07-15, 2026-07-16, 2026-07-20, 2026-07-25, 2026-07-27 (+9 more)

### Community 20 - "reset"
Cohesion: 0.08
Nodes (39): abortShowMethod(), animate(), applyMethodPose(), applyProjectionMorph(), cssVar(), drawMethodGhost(), drawMethodLabels(), drawMethodSheet() (+31 more)
...
### Community 23 - "methodCanRun"
Cohesion: 0.50
Nodes (5): beginShowMethod(), inclinationStageCount(), methodCanRun(), planMethodStages(), trueShapeForPlane()

## Knowledge Gaps
- **187 isolated node(s):** `rootStyle`, `DEFAULT_CAMERA_POSITION`, `DEFAULT_CAMERA_TARGET`, `DEFAULT_VIEW_DIR`, `QUICK_VIEWS` (+182 more)
