...
//
// No Three.js, no CDN import map (ADR-095/ADR-097): the viewport is inline SVG, drawing
// two linked first-angle views of a genuinely 3D helix rather than a 3D orbit scene — see
// ADR-097 for the full reasoning. Owns `state` (which construction is active, its given
