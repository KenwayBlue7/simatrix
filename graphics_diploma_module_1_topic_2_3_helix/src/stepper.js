...
// shares:
//   1. Choose  — pick one of the three helix constructions.
//   2. Given   — the right/left-hand toggle, then the curve's measurements.
//   3. Construct — the point sweeps around the cylinder/cone; scrub Sweep Angle or press
//      Play, watching both the top view and front view build together.
...
const STEPS = [
  { n: 1, title: 'Choose a Curve', lead: 'Pick a helix construction to build.' },
  { n: 2, title: 'Given', lead: 'Pick a hand (right or left), then set the measurements below.' },
  { n: 3, title: 'Construct', lead: 'Scrub the Sweep Angle slider or press Play — watch the top view fix each division’s position and the front view fix its height, together.' },
