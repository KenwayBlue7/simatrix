// Glossary popover (Module 1 Topic 1). Surfaces the inline
// <button class="term" data-t="…"> triggers that stepper.js injects into the step card,
...
// time stepper.js paints a step, so querying `.term` once on boot (as Module 2's terms.js
