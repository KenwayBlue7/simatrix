...
// foreshortening, true length, the Rotation Method — is marked up in the step copy
// (lineTypesData.js) as a dotted-underline `.term` <button data-t="…"> whose key
...
// once at startup. It imports lineTypesData.js the same pure-data way stepper.js
// does; it never touches the orchestrator or another behaviour leaf.

import { TERMS } from './lineTypesData.js';
